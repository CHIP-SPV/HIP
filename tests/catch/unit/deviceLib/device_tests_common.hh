...
#define GENERATE_KERNEL_LONGLONG(FUNCNAME, FUNC)                                                \
  __global__ void testKernel_##FUNCNAME(long long int* a) {                                    \
    FUNC;                                                                                       \
  }                                                                                             \
...
#define GENERATE_KERNEL_UNSIGNED(FUNCNAME, FUNC)                                               \
  __global__ void testKernel_##FUNCNAME(unsigned int* a) {                                     \
    FUNC;                                                                                       \
  }                                                                                             \
...
#define GENERATE_KERNEL_ULONGLONG(FUNCNAME, FUNC)                                                \
  __global__ void testKernel_##FUNCNAME(unsigned long long int* a) {                             \
    FUNC;                                                                                        \
  }                                                                                              \
